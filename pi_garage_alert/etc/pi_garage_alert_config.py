...
#1#            {
#1#                'state': 'open',
#1#                'time': garageDoor11AlarmOpenTimeOpen1,
#1#                'recipients': [ door1AlertEmailAddress1 ]
#1#            },
#1#            {
#1#                'state': 'open',
#1#                'time': garageDoor11AlarmOpenTimeOpen2,
#1#                'recipients': [ garageDoor11AlertEmailAddress2 ]
#1#         }
#1#        ]
#1#    }
#2#    , {
...
#2#                'recipients': [ door2AlertEmailAddress1 ]
#2#            },
#2#            {
#2#                'state': 'open',
